...
$stmt = $conn->prepare("SELECT content FROM pages WHERE slug = 'about'");
$stmt->execute();
...
// Obtener el template
$htmlTemplate = file_get_contents('about.html');
...
$modalHtml = <<<HTML
    ...
    function loadAdminContent(type) {
        if (type === 'login') {
            ...
            document.getElementById('dashboardFrame').src = 'admin/dashboard.php?page=about';
        }
    }

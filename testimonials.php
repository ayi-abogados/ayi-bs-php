...
$stmt = $conn->prepare("SELECT content FROM pages WHERE slug = 'testimonials'");
$stmt->execute();
...
// Obtener el template
$htmlTemplate = file_get_contents('testimonials.html');
...
$modalHtml = <<<HTML
    ...
    function loadAdminContent(type) {
        if (type === 'login') {
            ...
            document.getElementById('dashboardFrame').src = 'admin/dashboard.php?page=testimonials';
        }
    }

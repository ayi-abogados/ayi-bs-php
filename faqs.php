...
$stmt = $conn->prepare("SELECT content FROM pages WHERE slug = 'faqs'");
$stmt->execute();
...
// Obtener el template
$htmlTemplate = file_get_contents('faqs.html');
...
$modalHtml = <<<HTML
    ...
    function loadAdminContent(type) {
        if (type === 'login') {
            ...
            document.getElementById('dashboardFrame').src = 'admin/dashboard.php?page=faqs';
        }
    }
